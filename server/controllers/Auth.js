...
exports.signup = async (req,res)=>{
    try{
        const {firstName,lastName, email,password,confirmPassword,accountType,contactNumber,otp,sem}=req.body;
        ...
        return res.status(500).json({
            success: false,
            message: "user connat be registered. please try again.",
        });
    }
}
...
exports.changePassword = async(req,res)=>{
    try{
        ...
        if(newPassword !== confirmPassword){
            return res.status(400).json({
                success:false,
                message: "the passsword and confirm password does not match",
            });
        }
